...
def make_datapath_list(phase="train"):
    ...
    rootpath = "./"
    target_path = osp.join(rootpath+phase+"_images/*.png")
    print(target_path)
...
train_id_code, _, _, _ = train_test_split(
...
scheduler = optim.lr_scheduler.StepLR(optimizer, step_size=10) #10stepごとにlrを1/10倍
